...
export default function About() {
	const skill = {
		...
		hobby: ['playing video games', 'watching movies', 'spent some time with my family'],
	...
	return (
		<motion.section className="mb-28 max-w-[45rem] text-center leading-8 sm:mb-40" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.175 }}>
			...
			<p className="mb-3">
				...
				<br /> */}
				After earning a degree in <span className="font-medium">Sharia specialty</span>, I discovered my passion for programming and pursued it through a coding bootcamp, where I mastered{' '}
				<span className="font-medium">full-stack web development</span>. Problem-solving is <span className="italic">My favorite part of programming</span> —I thrive on finding creative solutions. My core stack includes{' '}
				<span className="font-medium">{joinWithAnd(skill.core)}</span>, and I'm also experienced with {joinWithAnd(skill.other)}. Always eager to learn, I'm now seeking a <span className="font-medium">full-time position</span> as a software
				developer to grow and contribute my skills.
			</p>
			...
			<p>
				...
				<br /> */}
				<span className="italic">When I'm not coding</span>, I enjoy {joinWithAnd(skill.hobby)}. I have a passion for learning and am currently exploring <span className="font-medium">{joinWithAnd(skill.interest)}</span>, and teaching myself
				to {joinWithAnd(skill.current)}.
			</p>
		</motion.section>
	)
}
